...
if First_Sea then
if Lv == 300 or Lv <= 324 or SelectMonster == "Military Soldier" or SelectArea == 'Magma' then -- Military Soldier
Ms = "Military Soldier"
...
ImageButton.Image = "rbxassetid://16207004882"
...
local function serversearch()
	...
	return maxplayers, serversmaxplayer, goodserver
end

local function getservers(cursor)
	local link = "https://games.roblox.com/v1/games/" .. game.PlaceId .. "/servers/Public?sortOrder=Asc&limit=100"
	if cursor then
		link = link .. "&cursor=" .. cursor
	end
	local data = game:GetService("HttpService"):JSONDecode(game:HttpGetAsync(link))
...
local function hopServerLowPlayer()
	...
	if AutoTeleport then
		local maxplayers, serversmaxplayer, goodserver = serversearch()
...
Tabs.Misc.Buttons.HopServerLowPlayer = {
	Title = "Hop Server Low Player",
	Description = "",
	Callback = hopServerLowPlayer
}

Tabs.Misc.Buttons.DevilShop = {
	Title = "Devil Shop",
	Description = "",
	Callback = function()
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
...
Tabs.Misc.Buttons.TitleName = {
	...
	Callback = function()
		...
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
		game.Players.localPlayer.PlayerGui.Main.Titles
